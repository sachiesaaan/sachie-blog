...
:root {
  ...
  --titleFont: "${getFontSpecificationName(theme.typography.title || theme.typography.header)}", "${getFontSpecificationName(theme.typography.title || theme.typography.header)} Fallback", ${DEFAULT_SANS_SERIF};
  --headerFont: "${getFontSpecificationName(theme.typography.header)}", "${getFontSpecificationName(theme.typography.header)} Fallback", ${DEFAULT_SANS_SERIF};
  --bodyFont: "${getFontSpecificationName(theme.typography.body)}", "${getFontSpecificationName(theme.typography.body)} Fallback", ${DEFAULT_SANS_SERIF};
  --codeFont: "${getFontSpecificationName(theme.typography.code)}", "${getFontSpecificationName(theme.typography.code)} Fallback", ${DEFAULT_MONO};
}
